  ...
  const handleSave = async () => {
    ...
    if (isEditing) {
      updateMutate({
        ...
        ...(form.organization_id !== editingPolicies.organization_id
          ? { organization_id: form.organization_id }
          : {}),
        ...(form.name !== editingPolicies.name ? { name: form.name } : {}),
        ...(form.description !== editingPolicies.description
          ? { description: form.description }
          : {}),
        ...(form.blocked_patterns !== editingPolicies.blocked_patterns
          ? { blocked_patterns: form.blocked_patterns }
          : {}),
        ...(form.applies_to_roles !== editingPolicies.applies_to_roles
          ? { applies_to_roles: form.applies_to_roles }
          : {}),
        ...(form.is_active !== editingPolicies.is_active
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label className="text-[#c0c5ce]">
              Blocked Patterns (comma separated)
            </Label>
            <Input
