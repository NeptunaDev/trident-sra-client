        ...
        <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-[#c0c5ce]">Create, update and delete policies.</p>
                </div>
                <Button
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-[#0f0f1c] border-b border-[rgba(91,194,231,0.2)]">
                            <tr className="text-left">
                                ...
                                <th className="py-3 px-4 text-[#c0c5ce] font-semibold">Created By</th>
                                <th className="py-3 px-4 text-[#c0c5ce] font-semibold">Blocked Patterns</th>
                                <th className="py-3 px-4 text-[#c0c5ce] font-semibold">Applies to Roles</th>
                                <th className="py-3 px-4 text-[#c0c5ce] font-semibold">Active</th>
                        ...
                        <tbody>
                            {policies?.length === 0 ? (
                                <tr>
                                    <td colSpan={9} className="py-10 px-4 text-center text-[#6b7280]">
                                        No results.
                                    </td>
                                </tr>
                            ) : (
