...
export const getCreateSessionSchema = () => {
    ...
    return z.object({
        ...
        connection_id: z
            .string()
            .min(1, messages.connectionIdRequired),
...
export type CreateSessionFormData = z.infer<ReturnType<typeof getCreateSessionSchema>>;
export type UpdateSessionFormData = z.infer<ReturnType<typeof getUpdateSessionSchema>>;
