...
import { Protocol, ConnectionStatus } from "./connections";
...
export const getCreateConnectionSchema = () => {
  ...
  return z.object({
    ...
    protocol: z.nativeEnum(Protocol, {
      required_error: messages.protocolRequired,
      invalid_type_error: messages.protocolRequired,
    }),
...
export type CreateConnectionFormData = z.infer<
  ReturnType<typeof getCreateConnectionSchema>
>;
export type UpdateConnectionFormData = z.infer<
  ReturnType<typeof getUpdateConnectionSchema>
>;
